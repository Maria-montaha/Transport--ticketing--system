        ...
        <div class="row gy-4">
          ...
          <div class="col-md-12 col-lg-4">
            <div class="card">
              ...
              <img
                src="{{ asset('assets/img/icons/misc/triangle-light.png') }}"
                class="scaleX-n1-rtl position-absolute bottom-0 end-0"
                width="166"
                alt="triangle background"
                data-app-light-img="{{ asset('assets/img/icons/misc/triangle-light.png') }}"
                data-app-dark-img="{{ asset('assets/img/icons/misc/triangle-dark.png') }}" />
              <img
